...
$emp = json_decode(file_get_contents("./resources/employees.json"), true);
...
foreach ($emp as $e) {
	...
	function get() :array
{
	$query = conn()->prepare("INSERT INTO employee_management values ($e["id"], $e["name"], $e["email"], $e["age"], $e["streetAddress"], $e["city"], $e["state"], $e["postalCode"], $e["phoneNumber"] );
